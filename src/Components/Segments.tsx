  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-lg md:text-xl font-bold font-Poppins">Segments</h2>
      </motion.div>
        ...
        {SegmentsList.map((segment, index) => (
          ...
          >
            ...
            <div className="relative z-10 flex flex-col justify-between h-full py-10 text-center px-4">
              <h3 className="text-xl md:text-2xl font-bold text-black mb-4 font-Poppins">
                {segment.name}
              </h3>
              <motion.button
                className="bg-[#1B1B1B] text-white text-sm md:text-base px-14 py-2 rounded-lg font-Poppins"
